...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,400,151.23}  // default steps per unit for Ultimaker
...
#define MEASURED_LOWER_LIMIT          1.70  //lower limit factor for sensor reading validation in mm
